...
<div class="wp-block-group contact-main shell">
	...
	<aside class="wp-block-group contact-details reveal">
		...
		<!-- wp:separator {"className":"blue-line small"} --><hr class="wp-block-separator has-alpha-channel-opacity blue-line small"/><!-- /wp:separator -->
		<!-- wp:group {"tagName":"article","layout":{"type":"flex","flexWrap":"nowrap"}} --><article class="wp-block-group"><!-- wp:group {"className":"round-icon","layout":{"type":"constrained"}} --><div class="wp-block-group round-icon"><!-- wp:icon {"icon":"core/envelope","align":"center"} /--></div><!-- /wp:group --><!-- wp:group {"layout":{"type":"default"}} --><div class="wp-block-group"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">Email</h3><!-- /wp:heading --><!-- wp:paragraph --><p><a href="mailto:info@md-concepts.com">info@md-concepts.com</a></p><!-- /wp:paragraph --></div><!-- /wp:group --></article><!-- /wp:group -->
		<!-- wp:group {"tagName":"article","layout":{"type":"flex","flexWrap":"nowrap"}} --><article class="wp-block-group"><!-- wp:group {"className":"round-icon","layout":{"type":"constrained"}} --><div class="wp-block-group round-icon"><!-- wp:icon {"icon":"core/mobile","align":"center"} /--></div><!-- /wp:group --><!-- wp:group {"layout":{"type":"default"}} --><div class="wp-block-group"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">Phone</h3><!-- /wp:heading --><!-- wp:paragraph --><p><a href="tel:+48123456789">+48 123 456 789</a></p><!-- /wp:paragraph --></div><!-- /wp:group --></article><!-- /wp:group -->
		<!-- wp:group {"tagName":"article","layout":{"type":"flex","flexWrap":"nowrap"}} --><article class="wp-block-group"><!-- wp:group {"className":"round-icon","layout":{"type":"constrained"}} --><div class="wp-block-group round-icon"><!-- wp:icon {"icon":"core/map-marker","align":"center"} /--></div><!-- /wp:group --><!-- wp:group {"layout":{"type":"default"}} --><div class="wp-block-group"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">Location</h3><!-- /wp:heading --><!-- wp:paragraph --><p>ul. Aluminium 1<br>00-000 Warsaw, Poland</p><!-- /wp:paragraph --></div><!-- /wp:group --></article><!-- /wp:group -->
	</aside>
	<!-- /wp:group -->
</div>
<!-- /wp:group -->
