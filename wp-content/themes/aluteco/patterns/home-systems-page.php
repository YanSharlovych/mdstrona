...
<div id="entry" class="wp-block-group product-section split-right">
	...
	<div class="wp-block-group product-info reveal"><!-- wp:paragraph {"className":"number"} --><p class="number">01</p><!-- /wp:paragraph --><!-- wp:heading {"level":2} --><h2 class="wp-block-heading">Entry<br>Doors</h2><!-- /wp:heading --><!-- wp:separator {"className":"blue-line small"} --><hr class="wp-block-separator has-alpha-channel-opacity blue-line small"/><!-- /wp:separator --><!-- wp:paragraph --><p>Elegant and secure entrance solutions that combine modern design with outstanding performance.</p><!-- /wp:paragraph -->
		<!-- wp:group {"className":"feature-icons","layout":{"type":"grid","columnCount":2}} -->
		<div class="wp-block-group feature-icons"><!-- wp:paragraph --><p>Pivot or hinged door mechanism</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>Multipoint locking system</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>Extremely large width and height</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>Customizable design and finishes</p><!-- /wp:paragraph --></div>
		<!-- /wp:group -->
	</div>
	<!-- /wp:group -->
...
<div id="loft" class="wp-block-group product-section split-left">
	...
	<!-- /wp:image -->
	<!-- wp:group {"className":"product-info reveal","layout":{"type":"default"}} -->
	<div class="wp-block-group product-info reveal"><!-- wp:paragraph {"className":"number"} --><p class="number">02</p><!-- /wp:paragraph --><!-- wp:heading {"level":2} --><h2 class="wp-block-heading">Loft<br>Systems</h2><!-- /wp:heading --><!-- wp:separator {"className":"blue-line small"} --><hr class="wp-block-separator has-alpha-channel-opacity blue-line small"/><!-- /wp:separator --><!-- wp:paragraph --><p>Sleek and versatile glass wall systems that define spaces while maintaining openness and natural light.</p><!-- /wp:paragraph -->
		<!-- wp:group {"className":"feature-icons","layout":{"type":"grid","columnCount":2}} -->
		<div class="wp-block-group feature-icons"><!-- wp:paragraph --><p>Slim profiles for minimalist design</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>Excellent sound insulation</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>Flexible configurations and finishes</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>Glass with variable transparency</p><!-- /wp:paragraph --></div>
		<!-- /wp:group -->
	</div>
	<!-- /wp:group -->
</div>
