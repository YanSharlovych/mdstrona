...
<div class="wp-block-group values shell">
	...
	<div class="wp-block-group value-grid">
		<!-- wp:group {"className":"value-card reveal","layout":{"type":"default"}} --><div class="wp-block-group value-card reveal"><!-- wp:group {"className":"icon shield","layout":{"type":"constrained"}} --><div class="wp-block-group icon shield"><!-- wp:icon {"icon":"core/shield","align":"center"} /--></div><!-- /wp:group --><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">Product quality</h3><!-- /wp:heading --><!-- wp:paragraph --><p>Premium materials and precision manufacturing ensure long-lasting performance.</p><!-- /wp:paragraph --></div><!-- /wp:group -->
		<!-- wp:group {"className":"value-card reveal","layout":{"type":"default"}} --><div class="wp-block-group value-card reveal"><!-- wp:group {"className":"icon bulb","layout":{"type":"constrained"}} --><div class="wp-block-group icon bulb"><!-- wp:icon {"icon":"core/tip","align":"center"} /--></div><!-- /wp:group --><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">Innovation</h3><!-- /wp:heading --><!-- wp:paragraph --><p>We continuously improve our solutions with modern technologies.</p><!-- /wp:paragraph --></div><!-- /wp:group -->
		<!-- wp:group {"className":"value-card reveal","layout":{"type":"default"}} --><div class="wp-block-group value-card reveal"><!-- wp:group {"className":"icon handshake","layout":{"type":"constrained"}} --><div class="wp-block-group icon handshake"><!-- wp:icon {"icon":"core/people","align":"center"} /--></div><!-- /wp:group --><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">Partnership</h3><!-- /wp:heading --><!-- wp:paragraph --><p>We build long-term relationships based on trust, transparency and reliability.</p><!-- /wp:paragraph --></div><!-- /wp:group -->
		<!-- wp:group {"className":"value-card reveal","layout":{"type":"default"}} --><div class="wp-block-group value-card reveal"><!-- wp:group {"className":"icon leaf","layout":{"type":"constrained"}} --><div class="wp-block-group icon leaf"><!-- wp:icon {"icon":"core/star-empty","align":"center"} /--></div><!-- /wp:group --><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">Responsibility</h3><!-- /wp:heading --><!-- wp:paragraph --><p>We care about the environment and design products for a sustainable future.</p><!-- /wp:paragraph --></div><!-- /wp:group -->
	</div>
	<!-- /wp:group -->
</div>
<!-- /wp:group -->
